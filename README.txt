...
- Run `./docker_run_notebook.sh drake-20190129 .` in the project directory to start the specified docker Drake container, mounting the current directory as the shared volume.
